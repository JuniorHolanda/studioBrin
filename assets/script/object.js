...
for (let i = 0; i < listProduct.length; i++){
    ...
    if (
        nome === 'bolsaPraiaDuo' || nome === 'bolsaTripCongresso' || nome === 'bolsaPst' || nome === 'miniBagVani' || nome === 'termicaJl'){
        alca = `assets/img/${nome}/alca.png`
    }

    // adiciona ziper aos aos produtos relativos
    if (nome === 'estojoTriang' || nome === 'bolsaTripCongresso' || nome === 'miniBagVani' || nome === 'necessaireEvBolso' || nome === 'termicaJl' ){
    ...
    if (nome === 'bolsaTripCongresso' || nome === 'termicaJl' ){
